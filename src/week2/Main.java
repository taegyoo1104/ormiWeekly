...
public class Main {
    ...
    public static void main(String[] args) {
        DeliveryChargeCalculator chargeCal;
        ...
        */
        chargeCal = new Beauty("뷰티1", BigDecimal.valueOf(10000), 11.0);
        chargeCal.getDeliveryCharge();
         ...
         */
        chargeCal = new Grocery("식료품1", BigDecimal.valueOf(50000), 2.0);
        chargeCal.getDeliveryCharge();
         ...
         */
        chargeCal = new LargeAppliance("가전1", BigDecimal.valueOf(1300000), 130.0);
        chargeCal.getDeliveryCharge();
